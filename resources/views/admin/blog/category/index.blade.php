        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Категории постов</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
                ...
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-success" href="{{ route('admin.blog.categories.create') }}">Создать</a>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table id="data-table-blog-categories" class="table table-hover table-bordered display mb-30" data-ajax-url="{{ route('admin.blog.categories.ajaxdata') }}">
                                        <thead>
                                            <tr>
                                                <th>Название</th>
