        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Редактирование поста</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Пост: {{ $post->name }}</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form method="post" action="{{ route('admin.blog.posts.update', compact('post')) }}" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PUT') }}
                                        ...
                                        <div class="tab-content" id="tabContent">
                                            <div  id="main" class="tab-pane fade active in" role="tabpanel">
                                                ...
                                                <div class="{{ ($errors->first('category_id')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <select name="category_id" class="form-control select2">
                                                        ...
                                                        @foreach($listCategories as $category)
                                                            ...
                                                            <option value="{{ $category->id }}" {{ (old('category_id', $post->categoryId) == $category->id) ? 'selected' : '' }}>{{ $category->name }}</option>
                                                ...
                                                <div class="{{ ($errors->first('name')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" id="post-name" class="form-control" name="name" value="{{ old('name', $post->name) }}">
                                                ...
                                                <div class="{{ ($errors->first('slug')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="slug" class="form-control slugify" data-source="#post-name" value="{{ old('slug', $post->slug) }}">
                                                ...
                                                <div class="{{ ($errors->first('small_description')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <textarea name="small_description" class="form-control" rows="10">{{ old('small_description', $post->small_description) }}</textarea>
                                                ...
                                                <div class="{{ ($errors->first('description')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <textarea name="description" class="form-control" rows="10">{{ old('description', $post->description) }}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-sm-6 ol-md-6 col-xs-12">
                                                        <div class="panel panel-default card-view">
                                                            ...
                                                            <div class="panel-wrapper collapse in">
                                                                <div class="panel-body">
                                                                    <input type="file" name="image" id="input-file-now-custom-2" class="dropify" accept="image/jpeg,image/png,image/jpg" data-allowed-file-extensions="jpeg jpg png" data-default-file="{{ ($post->hasImage()) ? $post->imageUrl : null }}" data-height="300" />
                                                ...
                                                <div class="{{ ($errors->first('date')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <div class='input-group datetimepicker'>
                                                      <input type='text' value="{{ old('date', $post->date) }}" name="date" class="form-control">
                                                ...
                                                <div class="form-group mb-30">
                                                    <div class="checkbox checkbox-primary">
                                                        <input type="checkbox" name="active" {{ (old('active', $post->active)) ? 'checked' : '' }}>
                                                        <label>Активно</label>
                                                    </div>
                                                </div>
                                                <!-- end post active -->
                                            ...
                                            <div  id="meta" class="tab-pane fade" role="tabpanel">
                                                ...
                                                <div class="{{ ($errors->first('meta_title')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title', $post->base_meta_title) }}">
                                                ...
                                                <div class="{{ ($errors->first('meta_description')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <textarea type="text" name="meta_description" class="form-control">{{ old('meta_description', $post->meta_description) }}</textarea>
