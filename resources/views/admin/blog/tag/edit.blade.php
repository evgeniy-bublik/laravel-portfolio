        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Редактирование тега</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Тег: {{ $tag->name }}</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form method="post" action="{{ route('admin.blog.tags.update', compact('tag')) }}">
                                    @csrf
                                    {{ method_field('PUT') }}
                                        ...
                                        <div class="tab-content" id="tabContent">
                                            <div  id="main" class="tab-pane fade active in" role="tabpanel">
                                                ...
                                                <div class="{{ ($errors->first('name')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" id="tag-name" class="form-control" name="name" value="{{ old('name', $tag->name) }}">
                                                ...
                                                <div class="{{ ($errors->first('slug')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="slug" class="form-control slugify" data-source="#tag-name" value="{{ old('slug', $tag->slug) }}">
                                                ...
                                                <div class="{{ ($errors->first('display_order')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="display_order" class="form-control" value="{{ old('display_order', $tag->display_order) }}">
                                                ...
                                                <div class="form-group mb-30">
                                                    <div class="checkbox checkbox-primary">
                                                        <input type="checkbox" name="active" {{ (old('active', $tag->active)) ? 'checked' : '' }}>
                                                        <label>Активно</label>
                                                    </div>
                                                </div>
                                                <!-- end tag active -->
                                            ...
                                            <div  id="meta" class="tab-pane fade" role="tabpanel">
                                                ...
                                                <div class="{{ ($errors->first('meta_title')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title', $tag->base_meta_title) }}">
                                                ...
                                                <div class="{{ ($errors->first('meta_description')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <textarea type="text" name="meta_description" class="form-control">{{ old('meta_description', $tag->meta_description) }}</textarea>
