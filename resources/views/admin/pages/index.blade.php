        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Страницы сайта</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Страницы сайта</h6>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table id="data-table-pages" class="table table-hover table-bordered display mb-30" data-ajax-url="{{ route('admin.pages.ajaxdata') }}">
                                        <thead>
                                            <tr>
                                                <th>Название</th>
                                                <th>Url</th>
