        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Редактирование работы</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Работа: {{ $work->name }}</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form method="post" action="{{ route('admin.portfolio.works.update', compact('work')) }}" enctype="multipart/form-data">
                                    @csrf
                                    {{ method_field('PUT') }}
                                        ...
                                        <div class="tab-content" id="tabContent">
                                            <div  id="main" class="tab-pane fade active in" role="tabpanel">
                                                ...
                                                <div class="{{ ($errors->first('category_id')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <select name="category_id" class="form-control">
                                                        ...
                                                        @foreach ($listCategories as $category)
                                                            ...
                                                            <option value="{{ $category->id }}" {{ ($category->id == old('category_id', $work->category_id) ) ? 'selected' : '' }}>{{ $category->name }}</option>
                                                ...
                                                <div class="{{ ($errors->first('name')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" id="work-name" name="name" class="form-control" value="{{ old('name', $work->name) }}">
                                                ...
                                                <div class="{{ ($errors->first('slug')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="slug" class="form-control slugify" data-source="#work-name" value="{{ old('slug', $work->slug) }}">
                                                ...
                                                <div class="{{ ($errors->first('description')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <textarea name="description" class="textarea_editor form-control">{{ old('description', $work->description) }}</textarea>
                                                ...
                                                <div class="{{ ($errors->first('url')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="url" class="form-control" value="{{ old('url', $work->url) }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-sm-6 ol-md-6 col-xs-12">
                                                        <div class="panel panel-default card-view">
                                                            ...
                                                            <div class="panel-wrapper collapse in">
                                                                <div class="panel-body">
                                                                    <input type="file" name="image" id="input-file-now-custom-2" class="dropify" accept="image/jpeg,image/png,image/jpg" data-allowed-file-extensions="jpeg jpg png" data-default-file="{{ ($work->hasImage()) ? $work->imageUrl : null }}" data-height="300" />
                                                ...
                                                <div class="{{ ($errors->first('date')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <div class='input-group datepicker'>
                                                      <input type='text' value="{{ old('date', $work->date) }}" name="date" class="form-control">
                                                ...
                                                <div class="{{ ($errors->first('technologies')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="technologies" class="form-control" value="{{ old('technologies', $work->technologies) }}">
                                                ...
                                                <div class="form-group mb-30">
                                                    <div class="checkbox checkbox-primary">
                                                        <input type="checkbox" name="active" {{ (old('active', $work->active)) ? 'checked' : '' }}>
                                                        <label>Активно</label>
                                                    </div>
                                                </div>
                                                <!-- end work active -->
                                            ...
                                            <div  id="meta" class="tab-pane fade" role="tabpanel">
                                                ...
                                                <div class="{{ ($errors->first('meta_title')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title', $work->meta_title) }}">
                                                ...
                                                <div class="{{ ($errors->first('meta_keywords')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <input type="text" name="meta_keywords" class="form-control" value="{{ old('meta_keywords', $work->meta_keywords) }}">
                                                ...
                                                <div class="{{ ($errors->first('meta_description')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                                    ...
                                                    <textarea type="text" name="meta_description" class="form-control">{{ old('meta_description', $work->meta_description) }}</textarea>
