        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Редактирование навыка</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Навык {{ $skill->name }}</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <form method="post" action="{{ route('admin.professional.skills.update', compact('skill')) }}">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="{{ ($errors->first('name')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ old('name', $skill->name) }}">
                                    ...
                                    <div class="{{ ($errors->first('value')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                        ...
                                        <input type="text" name="value" class="form-control percentage-range" value="{{ old('value', $skill->value) }}">
                                    ...
                                    <div class="{{ ($errors->first('color_bar')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                        ...
                                        <div  class="simple-colorpicker input-group colorpicker-component">
                                            <input type="text" name="color_bar" class="form-control" value="{{ old('color_bar', $skill->color_bar) }}">
                                    ...
                                    <div class="{{ ($errors->first('display_order')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                        ...
                                        <input type="text" name="display_order" class="form-control" value="{{ old('display_order', $skill->display_order) }}">
                                    ...
                                    <div class="form-group mb-30">
                                        <div class="checkbox checkbox-primary">
                                            <input type="checkbox" name="active" {{ (old('active', $skill->active)) ? 'checked' : '' }}>
                                            <label>Активно</label>
                                        </div>
                                    </div>
