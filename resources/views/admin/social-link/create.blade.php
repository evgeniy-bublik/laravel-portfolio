        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Создание социальной ссылки</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Создание социальной ссылки</h6>
                        </div>
                            ...
                            <div class="form-wrap">
                                <form method="post" action="{{ route('admin.social.links.store') }}">
                                    ...
                                    <div class="{{ ($errors->first('additional_classes')) ? 'form-group has-error has-feedback' : 'form-group' }}">
                                        ...
                                        <input type="text" name="additional_classes" class="form-control" value="{{ old('additional_classes') }}">
